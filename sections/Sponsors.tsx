...
const tiers = [
  ...
  },
  {
    ...
    color: '#c0c0c0',
    sponsors: [
      { name: 'VoltEdge',    img: 'https://ui-avatars.com/api/?name=VoltEdge&background=c0c0c0&color=06231D&size=128&bold=true' },
      { name: 'Renew Power', img: 'https://ui-avatars.com/api/?name=Renew&background=c0c0c0&color=06231D&size=128&bold=true' },
      { name: 'CESA Tech',   img: 'https://ui-avatars.com/api/?name=CESA&background=c0c0c0&color=06231D&size=128&bold=true' },
    ],
  },
  {
    ...
    color: '#cd7f32',
    sponsors: [
      { name: 'Zyod Labs',   img: 'https://ui-avatars.com/api/?name=Zyod&background=cd7f32&color=fff&size=128&bold=true' },
      { name: 'InnoHacks',   img: 'https://ui-avatars.com/api/?name=InnoHacks&background=cd7f32&color=fff&size=128&bold=true' },
      { name: 'ElecTrack',   img: 'https://ui-avatars.com/api/?name=ElecTrack&background=cd7f32&color=fff&size=128&bold=true' },
      { name: 'PowerSync',   img: 'https://ui-avatars.com/api/?name=PowerSync&background=cd7f32&color=fff&size=128&bold=true' },
    ],
  },
]
    ...
    <section id="sponsors" className="section-pad">
      <div className="max-w-7xl mx-auto">
        <AnimateIn>
          ...
          <p className="font-body text-[var(--text-secondary)] max-w-md mb-16 text-sm md:text-base">
              ...
              <StaggerContainer className="flex flex-wrap justify-center gap-4">
                {tier.sponsors.map((sp) => (
                  <StaggerItem key={sp.name}>
                    <motion.div
                      className="glass rounded-2xl p-6 flex flex-col items-center gap-3 cursor-pointer"
        ...
        <AnimateIn className="mt-16 text-center">
          <div className="card-base inline-block px-8 py-6 rounded-3xl">
            ...
            <a href="mailto:pie@ieee.org" className="btn-primary py-2.5 px-6 text-sm">
              Get in Touch
            </a>
          </div>
        </AnimateIn>
